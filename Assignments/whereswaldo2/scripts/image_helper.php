...
if ($argv[1] == 'run_image_tests') {
    ...
    $data = ['x'=>$rx,'y'=>$ry,'game_id'=>$game_id,'image_path'=>'/var/www/html/whereswaldo2/game_images','img_type'=>'png', 'bbox' =>[$rx,$ry,$rx+$waldo_width,$ry+$waldo_height] ];

    // put a single waldo on another image
    $waldoGame->place_waldo('/var/www/html/whereswaldo2/images/crowd.jpg', $waldoImg, $waldo_width, $waldo_height, $rx, $ry, $game_id.'.png', '/var/www/html/whereswaldo2/game_images');
    ...
    $waldoGame->make_transparent('/var/www/html/whereswaldo2/waldo_images/waldo_camping_537x429.jpg', [0,0,0], 'camping_transparent.png', '/var/www/html/whereswaldo2/scripts/test_output');
...
box1 = [(1,1),(4,4)]
def is_in(pt,box):
  if(pt[0] > box[0][0] and pt[0] < box[1][0]):
    if(pt[1] >box[0][1] and pt[1] <box[1][1]):
      return True
    else:
      return False
  else:
